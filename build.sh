...
ESP_HOMEKIT_SDK_COMMIT_HASH="43bab6f68569e26c738f0273960200c809ec0ec9";
...
git clone --quiet https://mirror.ghproxy.com/https://github.com/espressif/esp-homekit-sdk.git &> /dev/null;
